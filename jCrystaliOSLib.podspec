#
#  Be sure to run `pod spec lint jCrystaliOSLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Andrea Buitrago"
  # spec.authors            = { "Andrea Buitrago" => "ac.buitrago403@uniandes.edu.co" }
  # spec.social_media_url   = "https://twitter.com/Andrea Buitrago"
